...
<html>
<head>
<title>Pinstacular.com - Privacy</title>
...
<body class="privacy">
	<div class="page">
		...
		<div class="content centered">
			...
			<p>
			Pinstacular.com may collect and use Users personal information for the following purposes:	
				<ul>
					<li>
						<div>To improve our Site</div>
						We may use feedback you provide to improve our products and services.
					</li>
					<li>
						<div>To run a promotion, contest, survey or other Site feature</div>
			...
			<p>
			Pinstacular.com has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site, revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
			...
			<h4>Contacting us</h4>
			<p>
			If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, you may email us directly at :
			<a href="mailto:info@pinstacular.com?subject=info">info@pinstacular.com</a> or <a href="contactus.php">click here</a>.
			</p>
			<div class="privacy-date">This document was last updated on January 29, 2015</div>
		</div>
